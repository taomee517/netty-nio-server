...
//import com.fzk.dtu.utils.BCD6Util;
...
//import com.fzk.dtu.utils.ZeroFillStrUtil;
...
//        com.fzk.dtu.utils.ParseUtil.putTwoBytesInt(bf,downMsgId);
//
//        //消息体属性
//        //分包
//        int packSeparate = 0;
...
//        com.fzk.dtu.utils.ParseUtil.putTwoBytesInt(bf,msgInfo);
//
//        //手机号->设备序列号
...
//
//        //下行消息流水号
//        com.fzk.dtu.utils.ParseUtil.putTwoBytesInt(bf,serial);
//
//        /**消息内容部分*/
//        if(content!=null){
//            bf.put(content);
...
//
//        //需要校验的字节数据
//        byte[] validateContent = com.fzk.dtu.utils.ParseUtil.getReadableBytes(bf);
//
//        //校验码
